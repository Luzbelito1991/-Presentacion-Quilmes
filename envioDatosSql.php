...
echo "<br>";*/
        ...
        //1) Conexion -> mysqli_connect('servidorMySQL','UserMySQL','Password_User_MySQL','nombreBD')
            ...
            $conexion = mysqli_connect('localhost', 'root', '', 'quilmes') or die ("Error en la conexion.");

        
        //2) mysqli_query(conexion, consultaMySQL)


        $consultaAlta="INSERT INTO contacto values ('$nombre', '$apellido', '$email', '$mensaje')";

       /* $consultaAltaLinea="INSERT INTO contacto values ('matias', 'rodriguez', 'matias@gmail.com', 'hello world')";*/
            
            

        $consulta=mysqli_query($conexion,$consultaAlta);
